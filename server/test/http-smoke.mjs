...
const port = 31987;
const child = spawn(process.execPath, ['dist/server.js'], { env: { ...process.env, PORT:String(port), DATA_DIR:mkdtempSync(path.join(tmpdir(),'utmify-http-')), VOIDPAY_PUBLIC_KEY:'test', VOIDPAY_SECRET_KEY:'test', UTMIFY_API_TOKEN:'test' }, stdio:['ignore','pipe','pipe'] });
try {
